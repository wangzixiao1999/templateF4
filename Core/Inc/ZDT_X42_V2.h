...
extern int32_t ZDT_current; // 张大头电流
extern int32_t ZDT_speed;   // 张大头速度
extern int32_t ZDT_angle;   // 张大头角度
extern int32_t ZDT_state;   // 张大头状态
...
// 全局缓存变量
static ZDT_DataCache zdT_data_cache = {0};
