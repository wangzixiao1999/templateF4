...
#define YT8512C_PHYSCSR_SPEED_MASK             ((uint16_t)0xC000)                     /*!< Speed Mask */
#define YT8512C_PHYSCSR_SPEED_10M              ((uint16_t)0x0000)                     /*!< 10Mbps */
#define YT8512C_PHYSCSR_SPEED_100M             ((uint16_t)0x4000)                     /*!< 100Mbps */
#define YT8512C_PHYSCSR_DUPLEX                 ((uint16_t)0x2000)                     /*!< Duplex: 1=Full, 0=Half */
#define YT8512C_PHYSCSR_LINK                   ((uint16_t)0x0400)                     /*!< Link Status */
